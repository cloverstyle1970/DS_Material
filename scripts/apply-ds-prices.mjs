...
// Part No ??{ buyPrice, sellPrice } Îß??ùÏÑ±
...
console.log(`Í∞ÄÍ≤??∞Ïù¥?? ${priceMap.size}Í±?);

// part-list.json ?ÖÎç∞?¥Ìä∏
...
console.log(`?ÖÎç∞?¥Ìä∏ ?ÑÎ£å: ${updated}/${materials.length}Í∞??êÏû¨??Í∞ÄÍ≤??ÅÏö©`);
