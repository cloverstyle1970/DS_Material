      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg mx-4 overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            <h2 className="text-base font-semibold text-gray-800">신규 자재 등록</h2>
          ...
          <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4 max-h-[75vh] overflow-y-auto">
            ...
            <div className="bg-slate-50 rounded-lg px-4 py-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="text-xs text-slate-500 shrink-0">자동 채번 코드</span>
                <span className="font-mono text-sm font-bold text-slate-700 tracking-widest">{previewCode}</span>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <select value={isDs ? "D" : "_"} onChange={e => setIsDs(e.target.value === "D")}
                  className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-slate-400">
